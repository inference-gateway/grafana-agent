...
The codebase is generated using ADL CLI 0.24.1 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.24.1 or compatible version for regeneration
