...
The codebase is generated using ADL CLI 0.57.1 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.57.1 or compatible version for regeneration
