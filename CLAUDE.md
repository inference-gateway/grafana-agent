...
The codebase is generated using ADL CLI 0.30.10 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.30.10 or compatible version for regeneration
