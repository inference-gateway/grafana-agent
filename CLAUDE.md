...
The codebase is generated using ADL CLI 0.39.2 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.39.2 or compatible version for regeneration
