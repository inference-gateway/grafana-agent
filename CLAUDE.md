...
The codebase is generated using ADL CLI 0.55.0 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.55.0 or compatible version for regeneration
