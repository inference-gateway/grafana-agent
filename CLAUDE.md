...
The codebase is generated using ADL CLI 0.60.5 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.60.5 or compatible version for regeneration
