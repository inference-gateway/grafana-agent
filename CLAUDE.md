...
The codebase is generated using ADL CLI 0.62.9 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.62.9 or compatible version for regeneration
