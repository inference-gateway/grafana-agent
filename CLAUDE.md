...
The codebase is generated using ADL CLI 0.50.2 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.50.2 or compatible version for regeneration
