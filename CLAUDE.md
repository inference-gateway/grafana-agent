...
The codebase is generated using ADL CLI 0.39.3 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.39.3 or compatible version for regeneration
