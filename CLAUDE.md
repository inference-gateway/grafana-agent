...
The codebase is generated using ADL CLI 0.58.1 and follows a strict generation pattern:
...
- **ADL Version**: Ensure ADL CLI 0.58.1 or compatible version for regeneration
