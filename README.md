...
|-------|-------------|------------|
| `create_dashboard` | Creates a Grafana dashboard with specified panels, queries, and configurations | dashboard_title, deploy, description, grafana_url, metric_names, panels, prometheus_url, refresh_interval, tags, time_range, variables |
